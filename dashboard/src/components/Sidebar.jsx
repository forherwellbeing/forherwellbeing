...
export default function Sidebar({ role, activePage, setActivePage, onLogout, T, isMobile, isOpen, onClose }) {
  ...
  return (
    <>
      ...
      <div style={{
        ...
        top: 0,
        zIndex: 100,
        transform: isMobile && !isOpen ? 'translateX(-238px)' : 'translateX(0)',
